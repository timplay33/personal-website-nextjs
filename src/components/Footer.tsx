    ...
    <>
      <div className="justify-center flex gap-4 m-5">
        <a
          target="_blank"
          rel="noopener"
          href="https://github.com/timplay33"
          title="timplay33"
        >
          <svg className="h-10" role="img" viewBox="0 0 24 24">
            <title>GitHub</title>
        ...
        <a
          target="_blank"
          rel="noopener"
          href="https://www.instagram.com/tim.0409/"
          title="@tim.0409"
        >
          <svg className="h-10" role="img" viewBox="0 0 24 24">
        ...
        <a
          target="_blank"
          rel="noopener"
          href="mailto:tim@familie-heidler.de"
          title="tim@familie-heidler.de"
        >
          <svg className="h-10" role="img" viewBox="0 0 24 24">
            <title>E-mail</title>
